<template>
  <div>
    <button @click="showModal()" class="btn btn--light btn--small btn-report">
    ...
    <transition name="fade">
      <div class="modal-outlay" @click.self="closeModal()" v-show="state.active">
        <transition name="slidebottom">
          <div v-show="state.active" class="modal">
            ...
            <div class="modal__body modal__body--claim">
              ...
              <div class="avatar avatar--modal">
                    <img class="avatar__img is-company avatar__img--small avatar__img--modal" :src=" typeof company_logo == 'undefined' || company_logo == null || company_logo == '' ? '/img/default.svg' : '/'+company_logo" :alt="company_name + 'logo'">
              </div>
              <div class="form form--claim">
                <div class="field field--full-width">
                  ...
                  <input class="input" autocomplete="off" id="claim_profile"  name="email" :placeholder="'Enter email address i.e. hello@'+company_url+''"  type="email">
                </div>
                <div class="field field--full-width">
